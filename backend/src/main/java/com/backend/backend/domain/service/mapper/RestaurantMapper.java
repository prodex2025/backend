...
public class RestaurantMapper {
    ...
    // 店舗詳細ヘッダーDTOセット
    public static RestaurantCategoryDetailDto toRestaurantDetailHeader(Restaurant restaurant, List<RestaurantCategory> restaurantCategory, String imageUrl) {
       // DTOにセット
        ...
        restaurantCategoryDetailDto.setImageUrl(imageUrl);
    ...
    //店舗情報
    public static RestaurantDetailDto toRestaurantProfileDto(Restaurant restaurant, List<StoreSchedule> storeSchedules, String signedUrl){
